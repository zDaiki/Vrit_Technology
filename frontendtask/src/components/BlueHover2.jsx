...
const BlueHover2 = () => {
  return (
    ...
    <div className="relative  w-[580px] h-[340px] overflow-hidden rounded-xl">
      <img src={bluehover2} alt="Red Decoration" className='absolute w-[572px] h-[329px] top-[24px] left-[10px] object-cover' />
    </div>

      <div className='absolute top-10 left-[90px] text-center'>
        <h1 className='text-2xl font-bold text-white'>Laptops, lessons, and a whole lot of
            <br /> growth!</h1>
      </div>
      {/* Left notch */}
